...
public:
	ProfessorController(Root* root)
	{
		...
		mWalkList.push_back(Vector3(150.0f, 5.0f, 200.0f));
		mWalkList.push_back(Vector3(-150.0f,-10.0f, 200.0f));
		mWalkList.push_back(Vector3(150.0f, 24.0f, -200.0f));
		mWalkList.push_back(Vector3(-150.0f, 35.0f, -200.0f));
